          ...
          <div className="md:col-span-2">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 w-full border border-[#e5e5e5] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0ea5e9] focus:border-[#0ea5e9] text-black placeholder:text-[#9e9e9e]"
              />
            </div>
          </div>
