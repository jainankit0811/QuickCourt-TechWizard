    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <h1 className="text-2xl font-bold text-urbanGray-800">User Management</h1>
                    ...
                    <div className="md:col-span-2">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="pl-10 pr-4 py-2 w-full border border-neutral-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
                            />
                        </div>
                    </div>
                ...
                <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-neutral-200">
                        <thead className="bg-neutral-50">
                            <tr>
                                <th className="px-6 py-3 text-left text-xs font-medium text-urbanGray-500 uppercase tracking-wider">
                                    User
                                </th>
                                <th className="px-6 py-3 text-left text-xs font-medium text-urbanGray-500 uppercase tracking-wider">
                                    Role
                                ...
                                <tr key={user.id} className="hover:bg-neutral-50">
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="flex items-center">
                                            ...
                                            <div className="ml-4">
                                                <div className="text-sm font-medium text-urbanGray-900">
                                                    {user.name}
                                                </div>
                                                <div className="text-sm text-urbanGray-500">
                                                    {user.email}
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-urbanGray-500">
                ...
                {selectedUser && (
                    <div className="space-y-6">
                        <div className="flex items-center space-x-4">
                            ...
                            />
                            <div>
                                <h3 className="text-lg font-semibold text-urbanGray-800">{selectedUser.name}</h3>
                                <p className="text-urbanGray-600">{selectedUser.email}</p>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <p className="text-sm font-medium text-urbanGray-800">Role</p>
                                <p className="text-urbanGray-600">{selectedUser.role === 'facility_owner' ? 'Facility Owner' : 'User'}</p>
                            </div>
                            <div>
                                <p className="text-sm font-medium text-urbanGray-800">Joined Date</p>
                                <p className="text-urbanGray-600">{new Date(selectedUser.joinedDate).toLocaleDateString()}</p>
                            </div>
                            <div>
                                <p className="text-sm font-medium text-urbanGray-800">
                                    {selectedUser.role === 'user' ? 'Total Bookings' : 'Facilities Owned'}
                                </p>
                                <p className="text-urbanGray-600">
                ...
                {selectedUser && (
                    <div className="space-y-4">
                        <div className="flex items-center space-x-4 pb-4 border-b border-neutral-200">
                            ...
                            />
                            <div>
                                <h3 className="font-semibold text-urbanGray-800">{selectedUser.name}</h3>
                                <p className="text-sm text-urbanGray-600">Total bookings: {selectedUser.bookings}</p>
                            </div>
                        </div>

                        <div className="space-y-3">
                            {mockBookings.map((booking) => (
                                <div key={booking.id} className="bg-neutral-50 p-4 rounded-lg">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <h4 className="font-medium text-urbanGray-800">{booking.facility}</h4>
                                            <p className="text-sm text-urbanGray-600">{booking.sport}</p>
                                            <p className="text-sm text-urbanGray-500">{booking.date} at {booking.time}</p>
                                        </div>
